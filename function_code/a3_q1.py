...
def getAllStudents(): #gets all students from student table
    sendQ.execute("SELECT * FROM students4")
...
def addStudent(fn,ln,em,ed): #adds new student to student table
    addNew = """INSERT INTO students4(first_name,last_name,email,enrollment_date) VALUES (%s,%s,%s,%s)"""
